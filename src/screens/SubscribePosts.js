				...
				<div className="home" key={item._id}>
					<Card className={classes.root}>
						...
						<CardContent>
							...
							<Typography variant="body2" color="textSecondary" component="p">
								{item.Hashtags.join(', ').replace(/^|,\s*/g, "$&\#")}
							</Typography>
						</CardContent>
						...
						<CardContent className={classes.comments}>
							<Avatar>
								<img
									className={classes.avatar}
									alt=""
									// src="https://images.squarespace-cdn.com/content/v1/54b7b93ce4b0a3e130d5d232/1519986430884-H1GYNRLHN0VFRF6W5TAN/icon.png?format=750w"
